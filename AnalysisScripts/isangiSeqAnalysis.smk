...
rule raconX1:
	input:
		rules.denovo.output
	output:
		racon1 = temp('/home/ubuntu/data/belson/isangi_nanopore/qc/results/2021.01.18/{sample}_raconX1.fasta'),
		paf1 = temp('/home/ubuntu/data/belson/isangi_nanopore/qc/results/2021.01.18/{sample}.racon.paf')
	shell:
